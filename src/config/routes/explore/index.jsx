...
const __Actu__Section = lazy(() => import('@pages/explore/content/actu/actu'))
const __MAPC__Section = lazy(() => import('@pages/explore/content/mapHop/mapHop'))
...
function ExploreRoutes() {
  return (
      <Routes>
        ...
        <Route path="/map/:category" element={<__MAPC__Section />} />
        ...
        <Route path="/explore" element={<__Explore />}>
            ...
            <Route path="actu" element={<__Actu__Section />} />
        </Route>
      </Routes>
  )
}
