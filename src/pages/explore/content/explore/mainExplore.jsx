      ...
      <div className="exploreTitle">
          ...
          <div className="guide-navigation">
            ...
            <div className="horizontal">
              <div className='direction left'>Q <span>Gauche</span></div>
              <div className='direction right'>D <span>Droite</span></div>
            </div>
            
            <div className='direction down'>S <span>Bas</span></div>
          </div>
      </div>
